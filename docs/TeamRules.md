...
```
2. MySQL 스키마명, ID, URL, PW 확인해두기
2. [docs](/docs)로 이동해서 mysql-connector-j-8.0.33.tar.gz를 압축해제
3. 압축해제한 폴더 내에 있는 mysql-connector-j-8.0.33.jar를 따로 빼두기
4. IntelliJ에서 File > Project Structure > Library로 이동해서 .jar파일 추가하고 닫기
